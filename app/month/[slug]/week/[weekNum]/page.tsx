        ...
        <section>
          <div className="wrap" style={{ padding: 0 }}>
            <div className="journal-section" style={{ paddingTop: 0, borderBottom: "1px solid var(--border-soft)" }}>
              ...
              {/* Placeholder Notion DILETAKKAN DI SINI — kami hapus */}
            </div>
          </div>
        </section>
            ...
            <div className="journal-section">
              ...
              <div className="pull">
                {psychology ? (
                  ...
                  <p className="text-[#6E6B65] italic">✏️ Satu kalimat kunci soal psikologi minggu ini.</p>
                )}
              </div>
              <div className="body-copy">
                {psychology ? (
                  ...
                  <p className="text-[#6E6B65] italic">✏️ Refleksi lebih panjang — apa yang dirasakan, apa polanya, apa yang perlu diperhatikan minggu depan.</p>
                )}
              </div>
            </div>
              ...
              <div className="body-copy">
                {chartLesson ? (
                  <div className="whitespace-pre-wrap text-[#E8E6E1]">
                    <p><strong>Satu pelajaran utama:</strong> {chartLesson}</p>
                  </div>
                ) : (
